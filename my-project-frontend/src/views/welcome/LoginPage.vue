...
<template>
  <div style="text-align: center; margin: 0 20px" >
    <div style="margin-top: 150px">
      ...
      <div style="font-size: 14px; color: gray">在进入系统前请先输入用户名和密码进行登录</div>
    </div>
    <div style="margin-top: 50px">
      <el-form :model="form" ref="formRef" :rules="rule">
        ...
        <el-form-item prop="password">
          <el-input v-model="form.password" maxlength="15" type="password" placeholder="密码">
            <template #prefix>
    ...
    <div style="margin-top: 40px">
      <el-button style="width: 270px" type="success"  @click="userLogin"> 立即登录</el-button>
    </div>
    <el-divider>
